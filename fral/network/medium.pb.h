...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_medium_2eproto;
namespace medium {
class Allocation;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::medium::Allocation* Arena::CreateMaybeMessage<::medium::Allocation>(Arena*);
template<> ::medium::Empty* Arena::CreateMaybeMessage<::medium::Empty>(Arena*);
template<> ::medium::Start* Arena::CreateMaybeMessage<::medium::Start>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace medium {
...
class Start final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:medium.Start) */ {
 public:
...
class Allocation final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:medium.Allocation) */ {
 public:
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_allocation(const std::string& value);
...
// int32 idx = 1;
inline void Start::clear_idx() {
  _impl_.idx_ = 0;
}
inline int32_t Start::_internal_idx() const {
  return _impl_.idx_;
}
...
inline void Start::_internal_set_idx(int32_t value) {
...
void Allocation::set_allocation(ArgT0&& arg0, ArgT... args) {
 
 _impl_.allocation_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
